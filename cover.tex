...
%-----------------------------------------------------------------------
% \setmainfont{TeX Gyre Heros}                     % Main font, same as PhD thesis (Tex Gyre Heros)
% \setsansfont{TeX Gyre Adventor}                  % Sans Serif Font (for titles)
%-----------------------------------------------------------------------
...
\bookcovercomponent{normal}{front}[17mm, 20mm, 17mm, 20mm]{ % left, bottom, right, top
    ...
    \makebox[\partwidth][c]{\parbox{\partwidth-0.5cm}{
        ...
        \begin{flushright}
            ...
            \bfseries
            \MakeUppercase{Local Interaction Region Coupling Correction for the LHC}
        \end{flushright}
        % Small text
        \vspace{.1em}
