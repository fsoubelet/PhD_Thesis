...
\newglossaryentry{d1d2}{
        name={D1\&D2},
        text={D1/D2},
        description={D1 and D2 are the shorthands for the separation/recombination dipoles in the \glsfirstplural{ir} of the \glsfirst{lhc} and \glsfirst{hllhc}, diverting the \glspl{beam} from their respective beam-lines into the common aperture region around the \glsfirstplural{ip} and vice-versa}
}
