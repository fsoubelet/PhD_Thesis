...
\usepackage[cmyk]{xcolor}                          % the print office wants CMYK color definitions
\selectcolormodel{natural}                         % Until we load ninecolors and tabularray (see https://tex.stackexchange.com/questions/614621/tabularray-and-rgb-xcolor-option)
\usepackage{ninecolors}                            % Load now with compat for xcolor
...
% ----- Tables Related ----- %
\selectcolormodel{cmyk}                            % back to CMYK just before tabularray (for printshop)
