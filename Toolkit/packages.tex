...
\usepackage[bibstyle=numeric, citestyle=numeric-comp, sorting=none]{biblatex}  % citations and bibliography
...
% \usepackage{hyperref}  % hyperlinks through the document | loaded by cleveref
\hypersetup{
  linkcolor=cern,
  citecolor=cern,
  urlcolor=cern,
...
% \input{Toolkit/glossary_entries}
% \makenoidxglossaries
