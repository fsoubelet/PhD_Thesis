...
\Cref{fig:example_coupling_rdts} shows the reconstructed coupling RDTs for a given sample, calculated through the \textbf{C} matrix~\cite{PRAB:Calaga:MergingHamiltonianMatrixApproches}.
