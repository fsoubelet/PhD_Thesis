...
\todo{Write small section on amplitude detuning in the theory chapter.}

As mentioned in \cref{chapter:theory}, a measurement of the machine nonlinearities can be obtained by characterizing the \gls{ampdet}: the dependency of the tune as a function of the amplitude of particle oscillations.
...
Together with J.~Dilly\orcidlink{0000-0001-7864-5448}, we created a website for the OMC team to serve as a wiki, resource collection and entrypoint for team members.
