...
Amplitude detuning traditionally comes from octupolar fields and is used for beam stabilisation against collective effects.
...
\begin{figure}[!htb]
    ...
    \caption{Natural horizontal tune \(Q_x\) shift with horizontal free or forced action (\(J_{x}\) or \(A_x\)), in the case of free oscillations (\textcolor{mplorange}{orange}) and driven motion with \(\Delta Q_x = -0.01\) (\textcolor{mplblue}{blue}) and \(\Delta Q_x = -0.005\) (\textcolor{mplred}{red}).}
...
\begin{figure}[!htb]
    ...
    \caption{Natural vertical tune \(Q_y\) shift with horizontal free or forced action (\(J_{x}\) or \(A_x\)), in the case of free oscillations (\textcolor{mplorange}{orange}) and driven motion with \(\Delta Q_x = -0.01\) (\textcolor{mplblue}{blue}) and \(\Delta Q_x = -0.005\) (\textcolor{mplred}{red}).}
