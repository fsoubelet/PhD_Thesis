...
\todo{For the phase say that the global corrections are relies on the best possible phase measurement and by paring them correctly this could improve the correction achieved. Emphasis that all machines have this issue and that the issue is general. Remove any phrases like this is to contribute to the OMC-team.}
