...
\todo{For the sextupoles, say that this is of importance to understand how the impact of the sextupolar corrections on our amplitude detuning measurements. Even if they don't have a large effect normally, if there had been a different scaling with the AC-dipole maybe they would? Now we know that they don't, that is also a result.}
