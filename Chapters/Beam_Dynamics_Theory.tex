...
The design, operation, performance, and safety of a particle accelerator depend on the beam dynamics.
...
\begin{figure}[!htb]
    ...
    \caption{Illustration of a design closed orbit (blue) and a particle orbit oscillating around it (red). \todo{Not exactly!}}
...
\(\beta_z(s)\) is the \intro{beta-function} and represents beam envelope, or size, around the ring: it describes the transverse position dependent amplitude of the oscillation and has the dimension of a length.
