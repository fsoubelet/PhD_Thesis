...
The \intro{instantaneous luminosity} \(\mathcal{L}\) is the proportional factor between the number of events per unit time \(dR / dt\) and the cross-section \(\sigma_{\mathrm{cross}}\):
...
\cite{PHD:Vanbavinckhove, PHD:Keintzel}
