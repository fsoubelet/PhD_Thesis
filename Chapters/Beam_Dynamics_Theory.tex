...
The transfer matrix of a \gls{skew} quadrupole is:
...
\end{equation}
where the various \(2 \times 2\) matrices are expressed as:
...
\end{equation}
and \(\omega = \sqrt{k_{1s}}\) is used for clarity.
\Gls{betatron_coupling} will be discussed in more details later on, and for now only the \num{2}D case of a given plane will be considered.
