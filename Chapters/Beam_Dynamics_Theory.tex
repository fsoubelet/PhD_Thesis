...
\begin{figure}[!htb]
    ...
    \caption{Illustration of a design reference orbit (\textcolor{mplblue}{blue}), a closed orbit (\textcolor{mplorange}{orange}) and a particle trajectory (\textcolor{red}{red}).}
