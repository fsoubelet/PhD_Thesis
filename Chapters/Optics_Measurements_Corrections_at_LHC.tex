...
% After any modification to the LHC lattice, the linear optics must be commissioned in order to verify that the machine complies with these safety requirements.
% The linear optics must be rectified if the machine is discovered to operate outside of the safe tolerances. 
