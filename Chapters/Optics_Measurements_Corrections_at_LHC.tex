...
The model knowledge traditionally comes from the \acrshort{MAD}-X code~\cite{CODE:MADX_guide} for LHC measurements.
...
Application to the latter is detailed in the next chapter.
