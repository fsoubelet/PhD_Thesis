...
The LHC consists of eight \intro{octants} each intersected by an \intro{Insertion Region} (IR).
...
An illustration on naming conventions can be found in \cref{appendix:naming_conventions}.
...
\begin{figure}[!hbt]
  \centering
  \includegraphics*[width=0.9\linewidth]{Figures/Chapter3/lhc_fodo_cell.pdf}
...
\begin{figure}[!hbt]
  \centering
  \includegraphics*[width=0.9\linewidth]{Figures/Chapter3/lhc_arc23.pdf}
...
\begin{figure}[!hbt]
  \centering
  \includegraphics*[width=0.9\linewidth]{Figures/Chapter3/lhc_dispersion_suppressor.pdf}
