...
In the case of the coupling RDTs, due to the lower number of magnets available for adjustment one usually tries to compensate for the \glspl{RDT} at the edges of the segment.
