...
\begin{figure}[h]
    ...
    \caption{Simplified illustration of the LHC operational cycle.}
...
In \num{2022} a \betastar-leveling was introduced, were collisions start at a \(\beta^{\ast}\) of \qty{60}{\centi\meter}, and the \(\beta^{\ast}\) is progressively reduced to \qty{30}{\centi\meter} during stable beams in order to limit pile-up for the experiments.
\todo{REF.}
\todo{In \num{2023} an anti-telesqueeze in the ramp is performed, and a crossing-angle rotation at LHCb (IP\num{8}) is done when reaching flat top, in order to limit radiation of the nearby magnets.}
\todo{REF.}
