...
Optics corrections in the LHC are based on two different approaches.
...
Talk about response matrix approach.
\cite{EPAC:Tomas:Procedures_Accuracy_Estimates_Beta_Beat_Correction_LHC}

\subsubsection*{Local Corrections}

Talk about SbS~\cite{PRAB:Tomas:CERN_LHC_OMC}.
Get inspiration from PRAB paper for citations.
