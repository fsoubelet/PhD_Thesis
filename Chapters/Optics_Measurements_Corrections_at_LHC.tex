...
\begin{figure}[!htb]
  \centering
  \includegraphics*[width=0.99\linewidth]{Figures/Optics_Measurements_Corrections_at_LHC/cern_accelerator_complex.png}
...
Each arc in the LHC is made up of 23 cells of approximately \qty{106.9}{\meter}.
A simplified representation of an arc cell is given in~\cref{figure:lhc_arc_cell}, with on the layout subplot dipoles (MB) in blue, quadrupoles (MQ) in red, sextupoles (MS) in yellow, octupoles (MO) in green and BPMs represented as grey patches.

\begin{figure}[!hbt]
  \centering
  \includegraphics*[width=0.99\linewidth]{Figures/Optics_Measurements_Corrections_at_LHC/lhc_arc_cell.pdf}
  \caption{Simplified layout and optics functions in an LHC arc cell.}
  \label{figure:lhc_arc_cell}
\end{figure}
