...
Together, the two segments are responsible for matching the TWISS functions of the arcs to the desired values at the triplet entrance, and to reduce the dispersion to near-zero value, respectively.
...
\todo{Talk about the matching quadrupoles. Plots?}
