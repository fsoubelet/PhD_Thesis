...
\begin{equation}
  \frac{\Delta \beta_z(s)}{\beta_z(s)} = \frac{\beta_z(s)_{\mathrm{measured}} - \beta_z(s)_{\mathrm{nominal}}}{\beta_z(s)_{\mathrm{nominal}}} \quad \text { where } z = x, y \text{ .}
...
From these, comparisons to model values are made which allows for an assessment and understanding of the errors in the machine; and corrections can be calculated and applied to bring back the machine as close to the nominal scenario as possible.
