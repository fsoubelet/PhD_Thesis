...
\Cref{figure:rws_rematching_efficiency} shows a comparison of the simulated optics deviation induced by the RWS before and after applying the rematching knob, here implemented at IP\num{1}.
\todo{Talk more. Say we only show one, but it does good on other planes or beams too}
