...
\begin{noteblock}
    ...
    As one can see on \cref{figure:ir1_carry_over_vs_simulation}, the luminosity change from a \num{3.5} units trim of the colinearity knob (from \num{0} to \num{3.5} on the horizontal) leads to a \qty{11.6}{\percent} increase in the instantaneous luminosity.
    This value is higher than the \qty{9.7}{\percent} initially measured for an identical trim, and closer to the \qty{16}{\percent} expected in \cref{figure:expected_vs_observed_lumigains}.
\end{noteblock}
