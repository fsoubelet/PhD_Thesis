...
The outliers observed in the plot are luminosity measurement artifacts and can be safely dismissed.
...
It is expected to observe lower gains at a higher \(\beta^{\ast}\) since the \(\sqrt{\beta_x \beta_y}\) term of \cref{equation:deltaqmin_guignard} is substantially lower in the triplets for the less squeezed optics.
