...
\Cref{figure:corrections_trims_ir5} shows the trim performed at IR\num{5} during the same fill, with again the trim in \textcolor{mplblue}{blue} and recorded luminosity change in \textcolor{mplorange}{orange}.
...
A good improvement, though not as significant as at IR\num{1}, can be observed from the trim, with an almost overall \qty{4}{\percent} improvement from the adjustment.
...
\todo{Mention the weird spikes, they're artifacts.}
Unfortunately, due to higher priority tasks for the operators the trim was not performed in a single go to the desired value, and as a results the luminosity decrease in the time between the different parts of the trim.
\Cref{figure:corrections_trims_ir5_zoomed} shows a cut view of the data, where the time in between the various parts of the trim has been hidden (notice the cut in the horizontal axis). 
