...
This discrepancy suggests that - at least around IP\num{1} - the colinearity knob adjustment doesn't tell the full story and some other effects might be at play.
...
\begin{warningblock}
    ...
    This leads us to believe the IP\num{1} luminosity measurement in \cref{figure:expected_vs_observed_lumigains} might be an underestimation of the actual values, though it is not expected that the full discrepancy would be explained by this.
\end{warningblock}
...
\begin{figure}[!htb]
    ...
    \caption{Magnets powering (top) and horizontal (middle) and vertical (bottom) aperture limitations around IP\num{1}, at \(\beta^{\ast} =\) \qty{30}{\centi\meter}. The \textcolor{mplb}{blue} and \textcolor{mplr}{red} shaded areas represent, in each plane, the \(3 \sigma\), \(6 \sigma\) and \(11 \sigma\) beam envelopes, from darkest to lightest respectively.}
