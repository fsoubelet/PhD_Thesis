...
\Cref{figure:colinearity_knob_effect} bla bla bla

\begin{figure}[!htb]
    \centering
    \includegraphics*[width=0.95\columnwidth]{Figures/IR_Coupling_Correction/colinearity_knob_effect.pdf}
    \caption{Amplitude of the \(f_{1001}\) RDT in the vicinity of IP\num{1} under various strengths of the colinearity knob (\textcolor{mplblue}{blue}, \textcolor{mplorange}{orange} and \textcolor{mplpurple}{purple}). The \textcolor{mplred}{red} line corresponds to a scenario where global coupling is present in the machine. The location of the MQSX magnets implementing the coupling bump are highlighted as vertical \textcolor{mqsx_green}{green} lines.}
