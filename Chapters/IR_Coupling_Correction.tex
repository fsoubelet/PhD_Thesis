...
Show how it affects the beta-functions and breaks the symmetry in the IR (take the script and plot from pyhdtoolkit documentation).

\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.2\textwidth]{Figures/placeholder.png}
    \caption{GNAGNAGNA.}
    \label{figure:gnagnangwerjgkwevw}
\end{figure}
