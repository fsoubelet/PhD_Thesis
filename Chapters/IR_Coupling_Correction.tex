...
The beam sizes in the affected case are kept close to the nominal ones at less than a \qty{1}{\percent} deviation through the machine, being significantly affected only in the space between left to right Q\num{1}.
...
This option is still, however, in early stages of study.
