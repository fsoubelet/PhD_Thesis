...
For this, several containment scenarios were investigated that would try and compensate for a corrector's failure.
These are presented below.

\subsection{Correction Load Carry Over}

\todo{Port this from the IPAC article.}
