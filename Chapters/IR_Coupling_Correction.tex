...
The knob is designed so that a setting of \num{1} will result in a \qty{0.5}{\percent} change in the triplets knob powering, which induces a waist shift of \(\approx\)\qty{43.5}{\centi\meter}.
The individual triplet magnets trims are not used for this knob.
...
Talk about the impact it has on the optics outside the machine, and why it should be rematched.
