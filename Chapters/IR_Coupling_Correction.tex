...
This behavior was also observed in~\cref{PRAB:Hofer:Coupling_Local_Observables} where the coupling RDTs themselves are only significantly affected in the same space for a similar trim.
