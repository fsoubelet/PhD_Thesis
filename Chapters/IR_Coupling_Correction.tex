...
\Cref{table:correctors_peak_dose}, reproduced from~\cite{PRES:Cerutti:TripletLifetime_Evian}, shows the expected total received dose for different magnets in the main IRs, for various scenarios.
