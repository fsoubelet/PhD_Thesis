...
Some inconclusive measurements were performed that did not yield sensible correction suggestions, which have not been shown here.
...
\todo{Have the plot here to show the beta beating. Mention that we could for instance change the powering of the tilted triplet a bit to negate this impact on beta-beating. Do in simulation!}
