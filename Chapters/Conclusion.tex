...
\todo{Maybe a what can be done better paragraph?}
\break
...
\todo{The conclusion now feels (except the real end) like an introduction. Here is your chance to highlight your work, show that it is important. Talk on how the RWS is a novel method, to measure something we couldn’t measure before. The ML shows promising results but is not precise enough with the current instrumentation or method. The phase advance, shows the potential of paring BPMs for better phase and potentially beta measurement.}
