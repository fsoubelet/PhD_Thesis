...
Similarly, when too simple for the data at hand, the model will not be able to capture the underlying relations and will perform poorly on both training and test data.
This is referred to as \intro{underfitting}.
\Cref{figure:ml_underfitting_overfitting} illustrates these concepts by showing an underfitting model, an well chosen and trained model, and an overfitting model.
