...
\begin{figure}[!htb]
    \centering
    \includegraphics*[width=0.99\columnwidth]{Figures/ML_for_IR_Coupling/rdts_stdev_batch.pdf}
...
\begin{figure}[!htb]
    \centering
    \includegraphics*[width=0.99\columnwidth]{Figures/ML_for_IR_Coupling/ridge_performance.pdf}
...
\begin{figure}[!htb]
  \centering
  \includegraphics*[width=0.99\columnwidth]{Figures/ML_for_IR_Coupling/ridge_predictions.pdf}
...
\begin{figure}[!htb]
  \centering
  \includegraphics*[width=0.99\columnwidth]{Figures/ML_for_IR_Coupling/ridge_histograms.pdf}
