...
% \begin{figure}[!htb]
%     \centering
%     \includegraphics*[width=0.99\textwidth]{Figures/ML_for_IR_Coupling/ml_local_sources_b1_rdts.pdf}
...
%     \label{figure:ml_b1_local_sources_rdts}
% \end{figure}

% \begin{figure}[!htb]
%     \centering
%     \includegraphics*[width=0.99\textwidth]{Figures/ML_for_IR_Coupling/ml_local_sources_b2_rdts.pdf}
...
%     \label{figure:ml_b2_local_sources_rdts}
% \end{figure}
...
Convolutional Neural Networks (CNNs) have in the past been successfully used with impressive success on regression tasks - such as in high energy physics~\cite{Aurisano_2016} and recently in optics measurements studies~\cite{folOpticsCorrectionsUsing2019} - and would be a promising tool that could yield better prediction accuracy.
