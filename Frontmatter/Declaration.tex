...
\newline \newline
\noindent\todo{PRAB PAPER}: F. Soubelet \textit{et al.}, "Rigid Waist Shift: A New Method for Local Coupling Corrections in the LHC Interaction Regions", Phys. Rev. Accel. Beams \todo{some number here}, \num{2023}.
\newline \newline
\noindent\todo{IPAC23 Paper}: F. Soubelet \textit{et al.}, "Prospect of Operating with Limited Skew Quadrupole Corrector Availability in the LHC Interaction Regions", in Proceedings of \num{14}th Int. Particle Accelerator Conf. (IPAC'23), Venice, Italy, \todo{paper code}, \num{2023}.
\newline
\newline
\indent
...
\newline \newline
% \noindent\cite{REPORT:Soubelet:Simulations_Sextupolar_Contribution_AmpDet}: fwreds
% \newline \newline
% \noindent\cite{REPORT:Soubelet:Measured_Phase_Error_BPM_Type}: frwegrfedw
% \newline \newline
...
\newline \newline
\noindent\todo{JOSCH PAPER}: J. Dilly \textit{et al.}, "First Operational Dodecapole Correction in the LHC", Phys. Rev. Accel. Beams \todo{some number here}, \num{2023}.
\newline \newline
\noindent\todo{IPAC23 Contributions}: ... \textit{et al.}, "Some titles", in Proceedings of \num{14}th Int. Particle Accelerator Conf. (IPAC'23), Venice, Italy, \todo{paper code}, \num{2023}.
\newline \newline
