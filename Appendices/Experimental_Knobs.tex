...
The knobs are reported below as they have been implemented in the \intro{LHC Software Architecture} (LSA) framework.
...
\Cref{table:lsa_colinearity_knobs} shows the settings used in LSA to define the colinearity knobs at \(\mathrm{IR1}\) and \(\mathrm{IR5}\).
...
\Cref{table:lsa_rigid_waist_shift_knobs} shows the settings used in LSA to define the rigid waist shift knobs at \(\mathrm{IR1}\) and \(\mathrm{IR5}\).
