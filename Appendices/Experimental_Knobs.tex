...
The knobs are reported below as they have been implemented in the \intro{LHC Software Architecture} (LSA) framework~\cite{ICALEPS:Jacquet:LHC_Software_Architecture}.
...
% \Cref{table:lsa_ip1_colinearity_knob,table:lsa_ip5_colinearity_knob} show the settings used in LSA to define the colinearity knobs at IR\num{1} and IR\num{5}.
\Cref{table:lsa_colinearity_knobs} shows the settings used in LSA to define the colinearity knobs at IR\num{1} and IR\num{5}.
...
%         \hline
%     \end{tblr}
%     \caption{Definition of the colinearity knob for IR\num{1} as implemented in LSA.}
...
% \Cref{table:lsa_ip1_rigid_waist_shift,table:lsa_ip5_rigid_waist_shift} show the settings used in LSA to define the rigid waist shift knobs at IR\num{1} and IR\num{5}.
\Cref{table:lsa_rigid_waist_shift_knobs} shows the settings used in LSA to define the rigid waist shift knobs at IR\num{1} and IR\num{5}.
...
%         \hline
%     \end{tblr}
%     \caption{Definition of the rigid waist shift knob for IR\num{1} as implemented in LSA.}
...
\Cref{table:lsa_ip1_pos_rematching_knob,table:lsa_ip1_neg_rematching_knob} show the settings used in LSA to define the optics rematching knobs needed after applying the rigid waist shift knob, at IR\num{1}.
...
\Cref{table:lsa_ip5_pos_rematching_knob,table:lsa_ip5_neg_rematching_knob} show the settings used in LSA to define the optics rematching knobs needed after applying the rigid waist shift knob, at IR\num{5}.
