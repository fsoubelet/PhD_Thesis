...
\todo{I have a sign error in the phases, but I don't know where it comes from. Questions from Filip: are you sure that Eq. 1.44 is correct? Are you sure A.6 is correct? Are you sure A.15 is real part of A.13? (I don't think that the imaginary part of the exponensial can be disregarded so easily (I might be wrong))}
