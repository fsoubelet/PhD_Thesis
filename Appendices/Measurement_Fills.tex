...
\begin{table}[!hbt]
    ...
    \begin{tblr}{colspec={ccccc}}
        ...
        \hline
        6537              &  10/04/2018    &  \qty{450}{\giga\electronvolt}  &  \qty{11}{\metre}                      &  SbS Corrections Calculations    \\
...
\begin{table}[!hbt]
    ...
    \begin{tblr}{colspec={ccccc}}
        ...
        8072              &  30/07/2022     &  \qty{6.8}{\tera\electronvolt}  &  \qty{42}{\centi\metre}                       &  IR\num{1} \& IR\num{5} RWS Corrections Trim  \\
        8222              &  02/10/2022     &  \qty{6.8}{\tera\electronvolt}  &  \qty{30}{\centi\metre}                       &  IR\num{1} \& IR\num{5} Colin Knob Carry Over              \\
        8256              &  12/10/2022     &  \qty{6.8}{\tera\electronvolt}  &  \qty{30}{\centi\metre}                       &  IR\num{1} Colin Knob Carry Over              \\
        \hline
    \end{tblr}
    \caption{List of the LHC fills used in the experimental campaign, during the LHC \num{2022} Physics Run.}
