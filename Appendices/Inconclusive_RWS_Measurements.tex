...
Additionally, when reproducing this setup in simulations the obtained \glssymbol{Cminus} curve exhibits a suspicious behavior far from what would be expected (see \cref{figure:knob_to_cminus_with_waist}) and comparison with measurement data suggests a \textit{very} large error to be corrected: \num{15} units of the colinearity knob.
This data was discarded when determining corrections.
\todo{HAVE A NEW LOOK AT SIMULATIONS}
