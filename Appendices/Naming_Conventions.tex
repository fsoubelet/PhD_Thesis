...
An \kl{Interaction Point} in the strict sense is a location where the two beams are made to collide, which only happens in octants 1, 2, 5 and 8 where experiments are run.
